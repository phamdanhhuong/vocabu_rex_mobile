        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 12),
              AppButton(label: 'Highlight', onPressed: () {}, variant: ButtonVariant.highlight, width: 120),
              SizedBox(width: 12),
              AppButton(label: 'Alternate', onPressed: () {}, variant: ButtonVariant.alternate, width: 120),
              SizedBox(width: 12),
              AppButton(label: 'Outline', onPressed: () {}, variant: ButtonVariant.outline, width: 120),
              SizedBox(width: 12),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              WordTile(word: "Đây", onPressed: () {}, state: WordTileState.defaults),
              WordTile(word: "là", onPressed: () {}, state: WordTileState.defaults),
              WordTile(word: "trạng thái", onPressed: () {}, state: WordTileState.defaults),
              WordTile(word: "mặc định", onPressed: () {}, state: WordTileState.defaults),
            ],
          ),
          const SizedBox(height: 24),

          // --- Hàng 2: Các trạng thái khác ---
          const Text('Trạng thái: Tương tác',
              style: TextStyle(color: AppColors.wolf)),
          const SizedBox(height: 8),
          Wrap(
            spacing: 8.0,
