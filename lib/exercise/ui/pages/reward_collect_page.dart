...
class RewardCollectPage extends StatefulWidget {
  ...
  const RewardCollectPage({super.key, required this.gems, required this.coins});
                              ...
                              return Transform.rotate(
                                ...
                                child: ScaleTransition(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      _isOpened
                                          ? 'assets/icons/reward_chest_open.png'
                                          : 'assets/icons/reward_chest_closed.png',
                                      fit: BoxFit.contain,
                                      errorBuilder:
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text:
                                        'Bạn đã hoàn thành một Nhiệm vụ hằng ngày và kiếm được ',
                                  ),
                                  TextSpan(
                  ...
                  builder: (context, child) {
                    final progress = Curves.easeOut.transform(
                      math.max(
                        ...
                        math.min(
                          1.0,
                          (_coinController.value * 1000 - particle.delay) /
                              1000,
                        ),
                      ),
                    );
