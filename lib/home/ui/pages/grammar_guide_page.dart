    ...
    return WebPageWrapper(
      mobileScaffold: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          leading: IconButton(
            icon: Icon(Icons.close, color: AppColors.bodyText, size: 28),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(color: AppColors.swan, thickness: 1.5),
              const SizedBox(height: 24),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Danh sách các thẻ
                    if (widget.skillEntity.grammars == null ||
                        widget.skillEntity.grammars!.isEmpty)
                      Center(
                        child: Padding(
