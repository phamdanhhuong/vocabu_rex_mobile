...
class _BattlePageState extends State<BattlePage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [Color(0xFFFF6B35), Color(0xFFFF4B4B)],
              ),
          ...
          Text(
            'Đấu quiz tiếng Anh 1v1 với người chơi khác!',
  ...
  Widget _statsRow(dynamic s) {
    return Row(
      children: [
        Expanded(
          child: _statCard('Thắng', '${s.wins}', AppColors.featherGreen),
        ),
  ...
  Widget _sectionTitle(String t) {
    return Row(
      children: [
        Expanded(child: Divider(color: AppColors.swan)),
        Padding(
  ...
  Widget _historyCard(dynamic h) {
    ...
    switch (h.result) {
      case 'WIN':
        rc = AppColors.featherGreen;
        rt = 'Thắng';
        ri = Icons.emoji_events;
        break;
      case 'LOSE':
        rc = AppColors.cardinal;
        rt = 'Thua';
        ri = Icons.close;
        break;
      default:
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  h.opponent?.displayName ?? (h.isBot ? 'Bot' : 'Unknown'),
                  style: TextStyle(
                ...
                Text(
                  '${h.myScore} - ${h.opponentScore} • +${h.xpEarned} XP',
                  style: TextStyle(
                    fontSize: 13,
                    color: AppColors.wolf,
                    fontFamily: 'DuolingoFeather',
