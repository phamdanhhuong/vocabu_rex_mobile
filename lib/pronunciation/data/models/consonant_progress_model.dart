class ConsonantProgressModel {
  ...
  factory ConsonantProgressModel.fromJson(Map<String, dynamic> json) {
    return ConsonantProgressModel(
      consonantId: json['consonantId'] ?? '',
      symbol: json['symbol'] ?? '',
      name: json['name'] ?? '',
  ...
  ConsonantProgressModel copyWith({
    String? consonantId,
    String? symbol,
    String? name,
    int? totalLessons,
  ...
  bool operator ==(Object other) {
    ...
    return other is ConsonantProgressModel &&
  ...
  @override
  String toString() {
    return 'ConsonantProgressModel(consonantId: $consonantId, symbol: $symbol, name: $name, totalLessons: $totalLessons, completedLessons: $completedLessons, progressPercentage: $progressPercentage, currentMasteryLevel: $currentMasteryLevel, lastReview: $lastReview)';
  }
}
